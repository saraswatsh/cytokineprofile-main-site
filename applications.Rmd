...
<div class="quick-access-box">
  ...
  <p>
    <strong>Shiny App:</strong> Launch the <a href="https://shiny.cytokineprofile.org/" target="_blank">CytokineProfile Shiny App</a> |
...
The app is available to access at [CytokineProfile Shiny App](https://shiny.cytokineprofile.org/).
